...
-- Create Smart Research Assistant template with CORRECT aiNode type
INSERT INTO tasks (user_id, title, description, status, platform, is_template, metadata, tags)
SELECT 
  id as user_id,
...
-- Create Code Review Assistant template with CORRECT aiNode type
INSERT INTO tasks (user_id, title, description, status, platform, is_template, metadata, tags)
SELECT 
  id as user_id,
